...
if __name__ == '__main__':
    setup_dict = {
        'name': 'example.labGB2BRKEnergy-R2024a',
        'version': '24.1',
        'description': 'A Python interface to example.labGB2BRKEnergy',
        'author': 'MathWorks',
        'url': 'https://www.mathworks.com/',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'example',
            'example.labGB2BRKEnergy'
        ],
        'package_data': {'example.labGB2BRKEnergy': ['*.ctf']}
    }
