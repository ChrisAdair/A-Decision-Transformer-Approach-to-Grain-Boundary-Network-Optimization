labGB2BRKEnergy MATLAB Python Package
...
2. Installing the labGB2BRKEnergy Package

A. Change to the directory that contains the file setup.py and the subdirectory 
labGB2BRKEnergy. If you do not have write permissions, copy all its contents to a 
...
3. Using the labGB2BRKEnergy Package

The labGB2BRKEnergy package is on your Python path. To import it into a Python script or 
session, execute:

    import labGB2BRKEnergy
